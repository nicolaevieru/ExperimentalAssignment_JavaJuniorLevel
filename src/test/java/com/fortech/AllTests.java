...
@SuiteClasses({ CreateAccountIT.class, DeleteAccountIT.class, 
	GetAccountCartDetailsIT.class, GetAccountCartDetailsIT.class, GetCustomersIT.class, GetOrdersIT.class, 
	LoginIT.class, PlaceOrderIT.class,ChangeOrderStatusIT.class, AddVinylToCartIT.class, DeleteVinylIT.class, 
	GetAllVinylsDetailsIT.class, UpdateVinylInfoIT.class, VinylCreateIT.class })
